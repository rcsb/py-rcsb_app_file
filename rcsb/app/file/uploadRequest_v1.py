...
router = APIRouter(dependencies=[Depends(JWTAuthBearer())], tags=["uploadPartial"])
...
class UploadPartialResult(BaseModel):
...
@router.post("/uploadPartial", response_model=UploadPartialResult)
async def uploadPartial(
